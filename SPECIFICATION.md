...
Адрес системы расчёта начислений может быть передан серверу системы лояльности «Гофермарт» через переменную окружения ОС `ACCRUAL_SYSTEM_ADDRESS` или через флаг `-a`.
