...
// Source: github.com/tanya-mtv/go-musthave-diploma-tpl.git/internal/repository (interfaces: Balance)
...
// DoWithdraw mocks base method.
func (m *MockBalance) DoWithdraw(arg0 int, arg1 models.Withdraw) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DoWithdraw", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// DoWithdraw indicates an expected call of DoWithdraw.
func (mr *MockBalanceMockRecorder) DoWithdraw(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DoWithdraw", reflect.TypeOf((*MockBalance)(nil).DoWithdraw), arg0, arg1)
}
